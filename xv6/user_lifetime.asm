...
_user_lifetime:     file format elf32-i386
...
int main(void)
{
  ...
  1c:	75 3c                	jne    5a <main+0x5a>
        //child process
        printf(2,"Child lifetime before sleep is: %d\n",lifetime());
  1e:	e8 78 03 00 00       	call   39b <lifetime>
  23:	51                   	push   %ecx
  24:	50                   	push   %eax
  25:	68 c8 07 00 00       	push   $0x7c8
  2a:	6a 02                	push   $0x2
  2c:	e8 2f 04 00 00       	call   460 <printf>
        sleep(1000);// sleep for 10 seconds
  31:	c7 04 24 e8 03 00 00 	movl   $0x3e8,(%esp)
  38:	e8 36 03 00 00       	call   373 <sleep>
        printf(2,"Child lifetime after sleep is: %d\n",lifetime());
  3d:	e8 59 03 00 00       	call   39b <lifetime>
  42:	83 c4 0c             	add    $0xc,%esp
  45:	50                   	push   %eax
  46:	68 ec 07 00 00       	push   $0x7ec
  4b:	6a 02                	push   $0x2
  4d:	e8 0e 04 00 00       	call   460 <printf>
  52:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  55:	e8 89 02 00 00       	call   2e3 <exit>
        wait(); // after child process finished
  5a:	e8 8c 02 00 00       	call   2eb <wait>
        printf(2,"Parent lifetime is: %d\n",lifetime());
  5f:	e8 37 03 00 00       	call   39b <lifetime>
  64:	52                   	push   %edx
  65:	50                   	push   %eax
  66:	68 0f 08 00 00       	push   $0x80f
  6b:	6a 02                	push   $0x2
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 27 08 00 00       	mov    $0x827,%ebx
        while(*s != 0){
