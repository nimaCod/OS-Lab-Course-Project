...
int main(void)
{
  ...
  5f:	58                   	pop    %eax
  60:	5a                   	pop    %edx
  61:	68 83 08 00 00       	push   $0x883
  66:	6a 01                	push   $0x1
  68:	e8 93 04 00 00       	call   500 <printf>
    printf(1, "1. Mohammad Ali Ghahari\n");
  6d:	59                   	pop    %ecx
  6e:	5b                   	pop    %ebx
  6f:	68 8f 08 00 00       	push   $0x88f
  74:	6a 01                	push   $0x1
  76:	e8 85 04 00 00       	call   500 <printf>
  ...
  e4:	50                   	push   %eax
  e5:	50                   	push   %eax
  e6:	68 b4 0b 00 00       	push   $0xbb4
  eb:	68 df 08 00 00       	push   $0x8df
  f0:	e8 d6 02 00 00       	call   3cb <exec>
      printf(1, "init: exec sh failed\n");
  f5:	5a                   	pop    %edx
  f6:	59                   	pop    %ecx
  f7:	68 e2 08 00 00       	push   $0x8e2
  fc:	6a 01                	push   $0x1
  fe:	e8 fd 03 00 00       	call   500 <printf>
      exit();
 ...
 109:	6a 01                	push   $0x1
 10b:	6a 01                	push   $0x1
 10d:	68 68 08 00 00       	push   $0x868
 112:	e8 c4 02 00 00       	call   3db <mknod>
    open("console", O_RDWR);
 117:	58                   	pop    %eax
 118:	5a                   	pop    %edx
 119:	6a 02                	push   $0x2
 11b:	68 68 08 00 00       	push   $0x868
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	eb 1a                	jmp    6a0 <printf+0x1a0>
          s = "(null)";
 686:	bb 01 09 00 00       	mov    $0x901,%ebx
        while(*s != 0){
