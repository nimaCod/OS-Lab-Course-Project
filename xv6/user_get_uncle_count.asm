  ...
  12:	31 db                	xor    %ebx,%ebx
{
  14:	51                   	push   %ecx
        pid = fork();
  15:	e8 c1 02 00 00       	call   2db <fork>

        if (pid < 0) {
  1a:	85 c0                	test   %eax,%eax
  1c:	78 1e                	js     3c <main+0x3c>
            printf(2, "Fork failed.\n");
            exit();
        } else if (pid == 0) {
  1e:	74 2f                	je     4f <main+0x4f>
    for (i = 0; i < 3; i++){
  20:	83 c3 01             	add    $0x1,%ebx
  23:	83 fb 03             	cmp    $0x3,%ebx
  26:	75 ed                	jne    15 <main+0x15>
    }
    ...
    {
        wait();
  28:	e8 be 02 00 00       	call   2eb <wait>
  2d:	e8 b9 02 00 00       	call   2eb <wait>
  32:	e8 b4 02 00 00       	call   2eb <wait>
    }
  ...
  3c:	50                   	push   %eax
  3d:	50                   	push   %eax
  3e:	68 c8 07 00 00       	push   $0x7c8
  43:	6a 02                	push   $0x2
  45:	e8 16 04 00 00       	call   460 <printf>
            exit();
  4a:	e8 94 02 00 00       	call   2e3 <exit>
            if (i == 2) {
  4f:	83 fb 02             	cmp    $0x2,%ebx
  52:	75 e3                	jne    37 <main+0x37>
                pid2 = fork();
  54:	e8 82 02 00 00       	call   2db <fork>
                if (pid2 == 0){
  59:	85 c0                	test   %eax,%eax
  5b:	75 da                	jne    37 <main+0x37>
                    int uncle_count = get_uncle_count();
  5d:	e8 31 03 00 00       	call   393 <get_uncle_count>
  62:	89 c3                	mov    %eax,%ebx
                    printf(1, "Child process %d: Uncle count = %d\n", getpid(), uncle_count);
  64:	e8 fa 02 00 00       	call   363 <getpid>
  69:	53                   	push   %ebx
  6a:	50                   	push   %eax
  6b:	68 d8 07 00 00       	push   $0x7d8
  70:	6a 01                	push   $0x1
  72:	e8 e9 03 00 00       	call   460 <printf>
  77:	83 c4 10             	add    $0x10,%esp
            exit();
  7a:	eb bb                	jmp    37 <main+0x37>
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb fc 07 00 00       	mov    $0x7fc,%ebx
        while(*s != 0){
 ...
 656:	73 10                	jae    668 <free+0x38>
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 687:	5e                   	pop    %esi
 688:	5f                   	pop    %edi
 689:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 6cd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6d0:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 719:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 742:	e8 e9 fe ff ff       	call   630 <free>
  return freep;
 747:	a1 b0 0a 00 00       	mov    0xab0,%eax
 ...
 774:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 777:	a3 b0 0a 00 00       	mov    %eax,0xab0
}
 ...
 78e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 b0 0a 00 00 b4 	movl   $0xab4,0xab0
 797:	0a 00 00 
    base.s.size = 0;
 79a:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 b4 0a 00 00 b4 	movl   $0xab4,0xab4
 7a6:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 7ab:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 7b2:	00 00 00 
    if(p->s.size >= nunits){
