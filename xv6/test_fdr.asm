...
int main(int argc, char *argv[])
{
  ...
  1d:	52                   	push   %edx
  1e:	50                   	push   %eax
  1f:	68 a8 07 00 00       	push   $0x7a8
  24:	6a 02                	push   $0x2
  26:	e8 15 04 00 00       	call   440 <printf>
        exit();
  2b:	e8 93 02 00 00       	call   2c3 <exit>
  ...
  33:	ff 72 04             	pushl  0x4(%edx)
  36:	e8 15 02 00 00       	call   250 <atoi>
    asm volatile(
  3b:	89 db                	mov    %ebx,%ebx
  3d:	89 c3                	mov    %eax,%ebx

    int res = find_digital_root();
  3f:	e8 1f 03 00 00       	call   363 <find_digital_root>

    asm volatile(
  44:	89 db                	mov    %ebx,%ebx
        "movl %0, %%ebx" ::"r"(prev));

    printf(1, "FDR : %d\n", res);
  46:	83 c4 0c             	add    $0xc,%esp
  49:	50                   	push   %eax
  4a:	68 bd 07 00 00       	push   $0x7bd
  4f:	6a 01                	push   $0x1
  51:	e8 ea 03 00 00       	call   440 <printf>

    exit();
  56:	e8 68 02 00 00       	call   2c3 <exit>
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	eb 1a                	jmp    5e0 <printf+0x1a0>
          s = "(null)";
 5c6:	bb c7 07 00 00       	mov    $0x7c7,%ebx
        while(*s != 0){
