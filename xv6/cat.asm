...
00000060 <cat>:
{
  ...
  a5:	52                   	push   %edx
  a6:	52                   	push   %edx
  a7:	68 3a 08 00 00       	push   $0x83a
  ac:	6a 01                	push   $0x1
  ae:	e8 0d 04 00 00       	call   4c0 <printf>
    exit();
  b3:	e8 8b 02 00 00       	call   343 <exit>
    printf(1, "\n");
  b8:	50                   	push   %eax
  b9:	50                   	push   %eax
  ba:	68 49 08 00 00       	push   $0x849
  bf:	6a 01                	push   $0x1
  c1:	e8 fa 03 00 00       	call   4c0 <printf>
    exit();
