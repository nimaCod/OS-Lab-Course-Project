...
free(void *ap)
{
 ...
 5d5:	a1 24 0a 00 00       	mov    0xa24,%eax
{
 ...
 5f6:	73 10                	jae    608 <free+0x38>
{
 ...
 621:	5b                   	pop    %ebx
  freep = p;
 622:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 627:	5e                   	pop    %esi
 628:	5f                   	pop    %edi
 629:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 66d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 670:	8b 3d 24 0a 00 00    	mov    0xa24,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6b9:	8b 3d 24 0a 00 00    	mov    0xa24,%edi
 ...
 6e2:	e8 e9 fe ff ff       	call   5d0 <free>
  return freep;
 6e7:	a1 24 0a 00 00       	mov    0xa24,%eax
 ...
 714:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 717:	a3 24 0a 00 00       	mov    %eax,0xa24
}
 ...
 737:	0a 00 00 
    base.s.size = 0;
 73a:	bf 28 0a 00 00       	mov    $0xa28,%edi
    base.s.ptr = freep = prevp = &base;
 73f:	c7 05 28 0a 00 00 28 	movl   $0xa28,0xa28
 746:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 749:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 74b:	c7 05 2c 0a 00 00 00 	movl   $0x0,0xa2c
 752:	00 00 00 
    if(p->s.size >= nunits){
