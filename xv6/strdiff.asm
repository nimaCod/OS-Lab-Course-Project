...
int main(int argc, char *argv[])
{
  ...
  2c:	6a 02                	push   $0x2
  2e:	e8 0d 05 00 00       	call   540 <printf>
        exit();
 ...
 147:	51                   	push   %ecx
 148:	51                   	push   %ecx
 149:	68 d0 08 00 00       	push   $0x8d0
 14e:	6a 02                	push   $0x2
 150:	e8 eb 03 00 00       	call   540 <printf>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 6c4:	eb 1a                	jmp    6e0 <printf+0x1a0>
          s = "(null)";
 6c6:	bb 18 09 00 00       	mov    $0x918,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 715:	a1 d4 0b 00 00       	mov    0xbd4,%eax
{
 ...
 736:	73 10                	jae    748 <free+0x38>
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 767:	5e                   	pop    %esi
 768:	5f                   	pop    %edi
 769:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 7ad:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7b0:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7f9:	8b 3d d4 0b 00 00    	mov    0xbd4,%edi
 ...
 822:	e8 e9 fe ff ff       	call   710 <free>
  return freep;
 827:	a1 d4 0b 00 00       	mov    0xbd4,%eax
 ...
 854:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 857:	a3 d4 0b 00 00       	mov    %eax,0xbd4
}
 ...
 86e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 d4 0b 00 00 d8 	movl   $0xbd8,0xbd4
 877:	0b 00 00 
    base.s.size = 0;
 87a:	bf d8 0b 00 00       	mov    $0xbd8,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 d8 0b 00 00 d8 	movl   $0xbd8,0xbd8
 886:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 88b:	c7 05 dc 0b 00 00 00 	movl   $0x0,0xbdc
 892:	00 00 00 
    if(p->s.size >= nunits){
